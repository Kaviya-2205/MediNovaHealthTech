...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    solutions: [
      ...
      { name: "EHR Systems", href: "#services" },
      { name: "AI Diagnostics", href: "#services" },
      { name: "Mobile Health", href: "#services" },
    ],
    resources: [
    ...
    <footer className="bg-card border-t border-border">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                  className="w-9 h-9 rounded-lg bg-muted hover:bg-primary hover:text-white transition-colors duration-300 flex items-center justify-center"
          ...
          <div>
            <h3 className="font-semibold text-card-foreground mb-4">Solutions</h3>
            <ul className="space-y-2">
